          ...
          <TabsContent value="community" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                ...
                <CardContent className="space-y-4">
                  {[
                    { rank: 1, name: "Alex Chen", points: 15420, avatar: "/Images/Placeholder/Avatar.png" },
                    { rank: 2, name: "Maya Rodriguez", points: 14890, avatar: "/Images/Placeholder/Avatar.png" },
                    { rank: 3, name: "Jordan Kim", points: 13750, avatar: "/Images/Placeholder/Avatar.png" },
                    { rank: 4, name: "You", points: 1250, avatar: "/Images/Placeholder/Avatar.png", isUser: true },
                  ].map((user, index) => (
                    <div
                      key={index}
